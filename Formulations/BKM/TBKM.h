...
public:
	...
	Double_t DVCS_UU_02(Double_t *kine, Double_t phi, TComplex t2cffs[4], TString twist);
	Double_t I_UU_02(Double_t *kine, Double_t phi, Double_t F1, Double_t F2, TComplex t2cffs[4], TString twist);
	//BKM10
